...
# x_train, y_train = train_input.testing_data()
# train_loader = []
...
#     train_loader.append(sample_loader)
#
# # testing data
...
#
# net = TDRL_v4(sensor_num, cycle_step, many2one=True)
...
# testing
# Tester_testing_data = Tester(model=net, test_dataloader=test_loader, saving_path=outputdir, maxlife=max_life)
...
# Tester_training_data.test()
# Tester_training_data.rul_curve(state='training', number=None, saving_data=False)
# Tester_training_data.sensor_data_curve(number=None)
...
# Tester_training_data.abstract_feature_curve(state='training', number=None)
# Tester_training_data.visualization_of_attention(number=None)
# Tester_training_data.degradation_pattern(number=60)
#
# # raw sensor
# Tester_training_data = Tester(model=net, test_dataloader=train_loader,
#                               saving_path=outputdir, maxlife=max_life, predict=False)
# Tester_training_data.sensor_data_curve(number=134, state='training')
#
#
# # CNN_layer effect
CNN_layer_effect()
