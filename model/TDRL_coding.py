...
net = TDRLCoding(sensor_num, cycle_step, many2one=True)
...
# Tester_testing_data.rul_curve(state='testing', number=None, saving_data=True)
...
Tester_training_data.rul_curve(state='training', number=0)
